...
- [x] Go-агент `0.6.13` в `main`: enrollment, heartbeat, inventory, метрики, очередь команд
...
- [x] Исправить аварийное завершение UCI-sync без `enrollment_token` в агенте `0.6.12` и
