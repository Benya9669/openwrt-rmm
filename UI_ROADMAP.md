...
Актуализировано: 2026-08-01. Общий порядок разработки находится в `ROADMAP.md`.
...
- [x] История update/rollback с install, reconnect и health result.
- [x] Административный canary rollout со статусами устройств и автоматической паузой.
...
- [x] Update progress, reconnect и итоговый health result.
- [x] Canary/group rollout и автоматическая остановка при ошибке или таймауте.
- [x] История обновлений и rollback.
- [ ] Предварительный просмотр совместимости и состава пакета до подтверждения операции.
